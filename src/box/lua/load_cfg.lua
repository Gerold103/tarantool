...
local function normalize_tt_node_name(name)
    if name == nil then
        return nil
    end
...
local modify_cfg = {
    ...
    replicaset_name    = normalize_tt_node_name,
    cluster_name       = normalize_tt_node_name,
    instance_name      = normalize_tt_node_name,
}
